...
/**
 * Redis 분산 락 테스트 - AOP 구현 버전
 */
@SpringBootTest
class CouponServiceV6Test {

    @Autowired
    private CouponServiceV6 couponServiceV6;
    ...
    @Test
    @DisplayName("Redis 분산 락으로 동시성 제어 - AOP 구현 버전")
    void distributedLockWithAOPTest() throws InterruptedException {
        // given
        ...
        for (int i = 0; i < threadCount; i++) {
            executorService.submit(() -> {
                try {
                    couponServiceV6.issueCoupon(couponId);
